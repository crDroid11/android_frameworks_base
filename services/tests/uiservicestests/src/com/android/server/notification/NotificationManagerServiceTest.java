...
public class NotificationManagerServiceTest extends UiServiceTestCase {
    ...
    public void enqueueNotification_acceptsCorrectToken() throws RemoteException {
        ...
        assertThat(received.getWhitelistToken()).isEqualTo(
        ...
        assertThat(mService.mNotificationList.get(0).getNotification().getWhitelistToken())
                .isEqualTo(NotificationManagerService.WHITEWLIST_TOKEN);
    }
    ...
    public void enqueueNotification_acceptsNullToken_andPopulatesIt() throws RemoteException {
        Notification receivedWithoutParceling = new Notification.Builder(mContext, TEST_CHANNEL_ID)
                .setContentIntent(createPendingIntent("content"))
                .build();
        assertThat(receivedWithoutParceling.getWhitelistToken()).isNull();
    ...
    @Test
    public void enqueueNotification_directlyThroughRunnable_populatesWhitelistToken() {
        Notification receivedWithoutParceling = new Notification.Builder(mContext, TEST_CHANNEL_ID)
                .setContentIntent(createPendingIntent("content"))
                .build();
        NotificationRecord record = new NotificationRecord(
                ...
                new StatusBarNotification(mPkg, mPkg, 1, "tag", mUid, 44, receivedWithoutParceling,
                        mUser, "groupKey", 0),
                mTestNotificationChannel);
        assertThat(record.getNotification().getWhitelistToken()).isNull();
    ...
    public void enqueueNotification_rejectsOtherToken() throws RemoteException {
        Notification sent = new Notification.Builder(mContext, TEST_CHANNEL_ID)
                .setContentIntent(createPendingIntent("content"))
                .build();
        sent.overrideWhitelistToken(new Binder());
        Notification received = parcelAndUnparcel(sent, Notification.CREATOR);
        assertThat(received.getWhitelistToken()).isEqualTo(sent.getWhitelistToken());
    ...
    public void enqueueNotification_customParcelingWithFakeInnerToken_hasCorrectTokenInIntents()
        ...
        Notification sentFromApp = new Notification.Builder(mContext, TEST_CHANNEL_ID)
                ...
                .setPublicVersion(new Notification.Builder(mContext, TEST_CHANNEL_ID)
                        ...
                        .build())
                .build();
        sentFromApp.publicVersion.overrideWhitelistToken(new Binder());
     ...
     * "always use the same whitelist token as the root notification" parts.
     */
    private static void writeNotificationToParcelCustom(Parcel parcel, Notification notif,
        ...
        parcel.writeStrongBinder(notif.getWhitelistToken());
    ...
    public void getActiveNotifications_doesNotLeakWhitelistToken() throws RemoteException {
        Notification sentFromApp = new Notification.Builder(mContext, TEST_CHANNEL_ID)
                .setContentIntent(createPendingIntent("content"))
                .setPublicVersion(new Notification.Builder(mContext, TEST_CHANNEL_ID)
                        .setContentIntent(createPendingIntent("public"))
        ...
        assertThat(receivedByNms.getWhitelistToken()).isEqualTo(
                NotificationManagerService.WHITELIST_TOKEN);
        mBinderService.enqueueNotificationWithTag(mPkg, mPkg, "tag", 1,
        ...
        assertThat(posted.getWhitelistToken()).isEqualTo(
                NotificationManagerService.WHITELIST_TOKEN);
        ...
        // Binder transition: NMS -> app. App doesn't have the whitelist token so clear it
        ...
        Notification.processWhitelistToken = null;
        ...
        assertThat(gottenBackByApp.getWhitelistToken()).isNull();
        assertThat(gottenBackByApp.contentIntent.getWhitelistToken()).isNull();
        assertThat(gottenBackByApp.publicVersion.getWhitelistToken()).isNull();
        ...
        assertThat(new Notification.WearableExtender(gottenBackByApp).getPages()
                .get(0).getWhitelistToken()).isNull();
        assertThat(new Notification.WearableExtender(gottenBackByApp).getPages()
